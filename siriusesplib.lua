    ...
    local espLibrary = {
        ...
        options = {
         ...
         minScaleFactorX = 4.4,
            ...
            healthBars = false,
            lowhealthbarcolor = Color3.new(1, 0, 0), 
            healthBarsSize = 1,
        ...
        runService:BindToRenderStep("esp_rendering", renderValue or (Enum.RenderPriority.Camera.Value + 1), function()
            for player, objects in next, self.espCache do
                ...
                if (character and torso) then
                    ...
                    objects.top.Text = player[self.options.nameoption]; 
            ...
            objects.side2.Visible = show and self.options.toolesp;
                    objects.side2.Font = self.options.font;
                    objects.side2.Size = self.options.fontSize;
                    objects.side2.Transparency = 1
                    objects.side2.Color = color or self.options.toolespcolor;
                    objects.side2.Text = findfirstChildOfClass(player.Character, "Tool") and findfirstChildOfClass(player.Character,"Tool").Name or "None";
                    objects.side2.Position = round(position + vector2New(size.X + 3, 9.3));
                    ...
                    objects.healthBar.Color = self.options.lowhealthbarcolor:Lerp(self.options.healthBarsColor, health / maxHealth);-- color or self.options.healthBarsColor;
